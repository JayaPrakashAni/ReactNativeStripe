...
import defaultImage from '../../Assets/Instruments/Tabla.jpg'
...
const TablaGurus = () => {
    ...
    useEffect(() => {
        fetch('https://my.bmusician.com/app/GetGurus/?faculty=percussion')
            ...
            .then(data => {
                const tablaGurus = data.gurus.filter(guru =>
                    guru.SpecializationNames.includes('tabla')
                );
                setGurus(tablaGurus);
            })
            .catch(error => {
